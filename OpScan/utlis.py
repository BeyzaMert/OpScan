...
#       print(myPoints)
    ...
    def showAnswers(img,myIndex,grading,ans,questions,choices):
        #buralarda 0 ve 1in yerleri farklı
        secW = int(img.shape[0]/questions)
        secH = int(img.shape[1]/choices)

        for x in range(0,questions):
            myAns= myIndex[x]
               #buralarda w ve hin yerleri farklı
            ...
            if grading[x]==1:
                ...
                myColor = (0,0,255)
                correctAns = ans[x]
                cv2.circle(img,((correctAns*secH)+secH//2,(x*secW)+secW//2),35,(0,255,0),cv2.FILLED)
